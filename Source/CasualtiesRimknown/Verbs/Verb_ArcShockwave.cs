...
namespace CasualtiesRimknown.Verbs
{
    ...
    public class Verb_ArcShockwave : Verb
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            SoundDef selectedSoundDef = !CasualtiesRimknown_Mod.settings.soundCannon_UseLoudBlastEffect ? DefOfs.SoundDefOf.CR_SoundCannon_Blast : DefOfs.SoundDefOf.CR_SoundCannon_BlastLoud;
